...
public class JsonKit {
    ...
    /*, "yyyy-MM-dd HH:mm:ss", JSON.DEFAULT_GENERATE_FEATURE,*/
    public static String toJsonWithPascalName(Object object) {
        return JSON.toJSONString(object, SerializeConfig.getGlobalInstance(), new SerializeFilter[]{new PascalNameFilter()}, SerializerFeature.WriteDateUseDateFormat);
    }
